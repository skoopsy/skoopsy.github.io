---
layout: post
title:  "STM32 #7: UART Communication on STM32F1xx with libopencm3"
...
![Image of board pinout](/docs/assets/img/bluepill-plus-pinout.png)

Check the exact 5v tolerance per pin/mode in the STM32F103 datasheet; UART RX (as input) is generally fine with 5v tolerant pins, but don’t drive non-tolerant pins above VDD, the pin out I found here shows a 3.3v limit on Serial2 pins. Plug in the TX pin of your chosing on the bluepill, I will use USART1 at pins PA_9 & PA_10.
